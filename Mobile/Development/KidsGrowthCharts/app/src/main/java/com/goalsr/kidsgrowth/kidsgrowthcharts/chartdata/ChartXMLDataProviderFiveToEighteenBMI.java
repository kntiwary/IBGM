...
public class ChartXMLDataProviderFiveToEighteenBMI {
    ...
    public ChartXMLDataProviderFiveToEighteenBMI(Context context, String gender, String chartType) {


        if (chartType.equals("IAPBMI")) {
        ...
        if (chartType.equals("BMI_0_to_18")) {
            AssetManager assetManager = context.getAssets();
            try {
